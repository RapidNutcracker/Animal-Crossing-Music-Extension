...
function saveOptions() {
	...
	} else if (document.getElementById('city-folk').checked) {
		game = 'city-folk';
	...
	if (document.getElementById('clear').checked) {
		weather = 'clear';
	} else if (document.getElementById('raining').checked) {
		weather = 'rain';
	} else if (document.getElementById('snowing').checked) {
		weather = 'snow';
	} else if (document.getElementById('live').checked) {
		weather = 'live';
	}
...
function restoreOptions() {
	chrome.storage.sync.get({
		...
		document.getElementById(items.game).checked = true;
...
document.getElementById('animal-crossing').onclick = saveOptions;
document.getElementById('city-folk').onclick = saveOptions;
document.getElementById('new-leaf').onclick = saveOptions;
document.getElementById('random').onclick = saveOptions;
document.getElementById('clear').onclick = saveOptions;
document.getElementById('raining').onclick = saveOptions;
document.getElementById('snowing').onclick = saveOptions;
document.getElementById('live').onclick = saveOptions;
